...
equation
  ...
  connect(max1.y,irr) annotation(Line(points={{71.7499,-12.2887},{84,-12.2887},
          {84,-40.4273},{105.5,-40.4273}},                                                                           color = {0,0,127}, smooth = Smooth.None));
  ...
  connect(const1.y,TSet) annotation(Line(points={{-34.134,-77.4166},{-0.5,
