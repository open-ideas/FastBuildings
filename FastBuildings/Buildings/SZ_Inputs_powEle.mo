...
equation
  connect(simFasBui.powEle,use.powEle) annotation(Line(points={{-86.193,78.5462},
          ...
          -40.6577}}));
  connect(use.heaPorRad,zon.heaPorRad) annotation(Line(points={{-17.7053,-44.6473},
          {-5.47009,-44.6473},{-5.47009,-4.10256},{-19.0598,-4.10256},{-19.0598,
          -3.65812}}));
  connect(use.heaPorCon,zon.heaPorCon) annotation(Line(points={{-17.6793,-36.6942},
          {-7.86325,-36.6942},{-7.86325,0.683761},{-18.4615,0.683761},{-18.4615,
          0.34188},{-19.0598,0.34188}}));
  connect(simFasBui.qHeaCoo,hva.qHeaCoo) annotation(Line(points={{-82.193,78.5462},
          {-82.193,50},{-10,50},{-10,8.72124},{8.0938,8.72124}},                                                                         color = {0,0,127}, smooth = Smooth.None));
