...
equation
  connect(zon.TZon,hva.TZon) annotation(Line(points={{-19.0598,-7.65812},{7.86325,
          -7.65812},{7.86325,-7.35031},{8.1619,-7.35031}}));
  connect(zon.heaPorRad,hva.heaPorRad) annotation(Line(points={{-19.0598,-3.65812},
  ...
  connect(zon.heaPorEmb,hva.heaPorEmb) annotation(Line(points={{-19.0598,4.33245},
