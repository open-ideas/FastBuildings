...
partial model Partial2Zone
  ...
  replaceable FastBuildings.Zones.BaseClasses.Partials.Partial_SZ zon2
    annotation (Placement(visible=true, transformation(
        origin={-31.0598,-51.6581},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Zones.BaseClasses.Wall_1C bou "boundary wall between zon1 and zon2"
...
equation
  ...
  connect(zon2.heaPorCon, bou.heaPor_a) annotation (Line(
      ...
      color={191,0,0},
      smooth=Smooth.None));
  connect(bou.heaPor_b, hva.heaPorCon) annotation (Line(
      points={{-6,-20},{-6,-20},{-6,-14},{-6,-14},{-6,0},{8.20513,0},{8.20513,
          0.690581},{8.1367,0.690581}},
      color={191,0,0},
      smooth=Smooth.None));
